...
class AuthManager {
  ...
  async startGitHubAuth() {
    ...
    const clientSecret = process.env.E14Z_GITHUB_CLIENT_SECRET || 'cc42039500f69b0ce22a4548d0f7e5a58c30ecd8';
      ...
      try {
        ...
        const tokenResponse = await fetch('https://github.com/login/oauth/access_token', {
          ...
          body: JSON.stringify({
            ...
            client_secret: process.env.E14Z_GITHUB_CLIENT_SECRET || 'cc42039500f69b0ce22a4548d0f7e5a58c30ecd8',
